...
<title>Sale Hunter - Search Results</title>
<!-- for-mobile-apps -->
...
if(isset($_SESSION["name"]))
{
	...
	echo'<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user" aria-hidden="true"></i><span class="caret"></span></a>
...
echo'<div align="center">';
	...
	//$row = $collection->find(array('$or' => array(array("brand" =>$product),array("product" =>$product))));
	  $row = $collection->find(array('$or' => array(array("brand" =>new MongoRegex("/$product/i")),array("product" =>new MongoRegex("/$product/i")))));
